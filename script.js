...
const addtionalInfo = document.createElement("section");
addtionalInfo.innerText = "additional info";
const showInfo = document.createElement("p");
addtionalInfo.append(showInfo);
const age = document.createElement("button");
age.setAttribute("data-attr", "age");
const mail = document.createElement("button");
mail.setAttribute("data-attr", "email");
